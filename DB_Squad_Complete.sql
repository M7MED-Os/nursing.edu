-- نظام الشلة - النسخة النهائية المحسّنة
-- ============================================
-- التحديثات:
-- 1. منع إنشاء تحديات متعددة في نفس الوقت
-- 2. دالة إنهاء يدوي للتحدي
-- 3. فحص التحديات المنتهية عند كل مشاركة
-- ============================================

-- الجزء 1: دالة المراقبة المحسّنة
-- ============================================
